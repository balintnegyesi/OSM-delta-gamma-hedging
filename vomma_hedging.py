...
gamma_hedge_dir = output_dir + '/gamma_vomma_hedge/' + MODE + "/"
...
for m in model:
    ...
    for N_rebalance in N_rebalance_list:
        ...
        for chunk_number in range(number_of_chunks):
            ...
            # vega, gamma, vomma, vanna
            sec_chunk = np.load(instrument_dir + '/chunk_' + str(chunk_number) + "/sec_sample.npy")
            diff_sec_chunk = np.load(instrument_dir + '/chunk_' + str(chunk_number) + "/dk_sec_sample.npy")
            hess_sec_chunk = np.load(instrument_dir + '/chunk_' + str(chunk_number) + "/dlk_sec_sample.npy")
            ...
            pnl_delta_chunk, \
                relative_pnl_delta_chunk = solver.vomma_hedging_portfolio(x_chunk, sec_chunk, diff_sec_chunk, hess_sec_chunk,
